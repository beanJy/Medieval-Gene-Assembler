    ...
    public class Dialog_CreateXenogerm : GeneCreationDialogBase
    {
        ...
        private bool DrawGenepack(Genepack genepack, ref float curX, float curY, float packWidth, Rect containingRect)
        {
            ...
            for (int i = 0; i < genesListForReading.Count; i++)
            {
                ...
                GeneUIUtility.DrawGeneDef(genesListForReading[i], rect2, this.inheritable ? GeneType.Endogene : GeneType.Xenogene, () => extraTooltip, doBackground: false, clickable: false, overridden);
